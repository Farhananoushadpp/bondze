          ...
          >
            ...
            >
              ...
              <p style={{ lineHeight: "1.7", color: "var(--text-light)" }}>
                Our African operations leverage deep local knowledge,
                established relationships, and a commitment to responsible
                development that creates mutual value.
              </p>
            </div>
          </div>
        </div>
          ...
          >
            ...
            >
              ...
              <p style={{ lineHeight: "1.7", color: "var(--text-dark)" }}>
                Dubai's position as a leading commodities trading center
                provides access to global markets, sophisticated logistics, and
