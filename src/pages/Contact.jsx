  ...
  return (
    <main>
      ...
      <section
        ...
        style={{
          backgroundImage: 'url("/images/image-04.webp")',
        }}
      >
        <div className="container">
          <h1 className="page-header-title">Contact</h1>
          <p className="page-header-subtitle">
            Get in touch with our team for inquiries and partnership
            opportunities.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-2" style={{ gap: "4rem" }}>
            ...
            <div>
              ...
              >
                ...
                stakeholders. Please use the contact form or reach out directly
      ...
      <section className="section section-light" style={{ padding: "3rem 0" }}>
        <div className="container">
          ...
          >
            ...
            >
              This contact form is protected by reCAPTCHA and the Google Privacy
              Policy and Terms of Service apply. We review all inquiries and aim
              to respond within 2-3 business days. For urgent matters, please
              indicate priority in your message subject line.
            </p>
            <p
              style={{
                color: "var(--color-text-secondary)",
            ...
            >
              <strong>
                Unsolicited marketing communications and sales solicitations
